...
import { IconHome } from "@tabler/icons-react";  // Importando o ícone "Home" do pacote Tabler Icons React

// Componente MenuItem que representa um item no menu de navegação
function MenuItem() {
    return (
        // Componente Link que cria um link de navegação para a página inicial
        // Adicionando classes do Tailwind para estilo e efeitos de hover
        <Link href="/" className="flex gap-2 px-4 py-2 hover:bg-black">
            {/* Ícone de Home, representando o ícone de navegação */}
            <IconHome />
            {/* Texto do item, descrevendo o destino do link */}
            <span>Home</span>  
        </Link>
    );
}
